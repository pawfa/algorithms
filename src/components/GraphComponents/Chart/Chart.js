...
class Chart extends Component {
  ...
  createBarChart = () => {
    ...
    const yScale = d3.scaleLinear().domain([0, dataMax]).range([height, 0]);
    ...
    verticalGuide.selectAll('path').styles({
      fill: 'none',
      stroke: '#3c763d',
    });
    verticalGuide.selectAll('line').styles({
      stroke: '#3c763d',
    });
